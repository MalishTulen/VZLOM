...
Сообщение "Acsess granted!" находится по адресу 77h. Так как в DOS адреса смещаются на 100 из-за Programm Segment Prefix(PSP), то, чтобы получить правильный адрес нужно прибавть к обнаруженному адресу 100h. Нужный адрес: 77h + 100h = 177h
...
Поменяем **je** на **jne** в функции сравнения паролей, и теперь программа принимает любой пароль.
...
<img src="image-21.png" width="400" /> <img src="image-20.png" width="400" />
