...
\
Это дает нам возможность переполнить код, и записать в стек адрес команды, дающей нам доступ. Для этого мы пишем программу которая сначла заполнит основной код FFFF - 0189h байт<details><summary>(FFFF - количество байт в сегменте, 189 - адрес буфера),</summary>
![alt text](image-8.png)</details>
